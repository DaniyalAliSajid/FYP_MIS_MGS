...
class SubjectsRegistered extends StatefulWidget {
  @override
  _SubjectsRegistered createState() => _SubjectsRegistered();
}

class _SubjectsRegistered extends State<SubjectsRegistered> {
  @override
